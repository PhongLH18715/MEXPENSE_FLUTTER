  ...
  Future<Database> getDatabase(String path) async {
    ...
    return await openDatabase(join(databasePath, path),
      ...
      return await db.execute(
          "CREATE TABLE IF NOT EXIST $TABLE_NAME ( $EXPENSE_ID INTEGER PRIMARY KEY AUTOINCREMENT, $EXPENSE_NAME TEXT, $EXPENSE_DATE TEXT, $EXPENSE_COST INTEGER, $EXPENSE_AMOUNT INTEGER, $EXPENSE_NOTES TEXT, $EXPENSE_TRIP_ID, FOREIGN KEY($EXPENSE_TRIP_ID) REFERENCES trip($TRIP_ID) ON DELETE CASCADE )");
    }), version: 1);
  }
